...
app.post('/agregar-receta', authMiddleware, (req, res) => {
    ...
    const query = "INSERT INTO receta (nombre, tiempo, dificultad, pasos, porciones, id_usuario) VALUES (?, ?, ?, ?, ?, ?)";
    connection.query(query, [nombre, tiempo, dificultad, pasos, porciones, userId], (err, result) => {
        if (err) {
